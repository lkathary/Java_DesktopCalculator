#include "model.h"
#include "com_example_calculator_models_Model.h"
#include "com_example_calculator_models_CreditCalc.h"
...
JNIEXPORT void JNICALL Java_com_example_calculator_models_Model_parsingStr(JNIEnv* env, jobject obj, jstring jstr) {
    ...
    if (!result) {
        ...
        jclass cls_lexeme = env->FindClass("com/example/calculator/models/Model$Lexeme");
        jmethodID midConstr = env->GetMethodID(cls_lexeme, "<init>", "(Lcom/example/calculator/models/Model;IID)V");
...
JNIEXPORT void JNICALL Java_com_example_calculator_models_CreditCalc_createPayments
  (JNIEnv* env, jobject obj, jdouble sum, jint num, jdouble interest , jint type) {
    ...
    jclass cls_payment = env->FindClass("com/example/calculator/models/CreditCalc$Payment");
    jmethodID midConstr = env->GetMethodID(cls_payment, "<init>", "(Lcom/example/calculator/models/CreditCalc;DDD)V");
